...
if (appVersion < 8) {
  ...
  IE7.CSS.addFix(/display\s*:\s*inline-block/, "display:inline;zoom:1");
...
progress{width:10em;}\
article,aside,figcaption,footer,header,hgroup,summary,section,nav{display:block}\
...
if (!window.Element) {
  ...
  var __querySelectorAll = function (selector) {
      return select(selector, Infinity);
  };
  var __querySelector = function (selector) {
      return select(selector, 1)[0] || null;
  };
  var __getElementsByClassName = function(search) {
    var d = document, elements, pattern, i, results = [];
      elements = __getElementsByTagName("*");
...
function addEventListener(type, listener) {
  var element = this, listeners = element.listeners = element.listeners || [], index = listeners.push([listener, function (e) {
...
window.attachEvent("onload",function(){
  for(i=0;i<document.getElementsByTagName("input").length;i++){
    if(document.getElementsByTagName("input")[i].value === "" && document.getElementsByTagName("input")[i].getAttribute("placeholder") !== undefined && document.getElementsByTagName("input")[i].getAttribute("placeholder") !== "")
    {
      document.getElementsByTagName("input")[i].value = document.getElementsByTagName("input")[i].getAttribute("placeholder");
      document.getElementsByTagName("input")[i].style.color = "#aaa";
      document.getElementsByTagName("input")[i].className += "placeholder";
    }

    if(document.getElementsByTagName("input")[i].getAttribute("placeholder") !== undefined && document.getElementsByTagName("input")[i].getAttribute("placeholder") !== "")
    {
      document.getElementsByTagName("input")[i].addEventListener("focus",function(){
        if(document.getElementsByTagName("input")[i].value === document.getElementsByTagName("input")[i].getAttribute("placeholder") && document.getElementsByTagName("input")[i].className.indexOf("placeholder") > -1){
  ...
  for(i=0;i<document.getElementsByTagName("textarea").length;i++){
    if(document.getElementsByTagName("textarea")[i].value === "" && document.getElementsByTagName("textarea")[i].getAttribute("placeholder") !== undefined && document.getElementsByTagName("textarea")[i].getAttribute("placeholder") !== "")
    {
      document.getElementsByTagName("textarea")[i].value = document.getElementsByTagName("textarea")[i].getAttribute("placeholder");
      document.getElementsByTagName("textarea")[i].style.color = "#aaa";
      document.getElementsByTagName("textarea")[i].className += "placeholder";
    }

    if(document.getElementsByTagName("textarea")[i].getAttribute("placeholder") !== undefined && document.getElementsByTagName("textarea")[i].getAttribute("placeholder") !== "")
    {
      document.getElementsByTagName("textarea")[i].addEventListener("focus",function(){
        if(document.getElementsByTagName("textarea")[i].value === document.getElementsByTagName("textarea")[i].getAttribute("placeholder") && document.getElementsByTagName("input")[i].className.indexOf("placeholder") > -1){
          document.getElementsByTagName("textarea")[i].style.color = "";
          document.getElementsByTagName("textarea")[i].value = "";
          document.getElementsByTagName("textarea")[i].className -= "placeholder";
        }
      });
      document.getElementsByTagName("textarea")[i].addEventListener("blur",function(){
      ...
      document.getElementsByTagName("textarea")[i].addEventListener("change",function(){
        document.getElementsByTagName("textarea")[i].style.color = "";
        if(document.getElementsByTagName("textarea")[i].value !== ""){
          document.getElementsByTagName("textarea")[i].className -= "placeholder";
        }
  ...
  for(i=0;i<document.getElementsByTagName("form").length;i++){
    for(i=0;i<document.getElementsByTagName("input").length;i++){
      if(document.getElementsByTagName("input")[i].value === document.getElementsByTagName("input").getAttribute("placeholder")){
        document.getElementsByTagName("input")[i].value = '';
      }

      for(i=0;i<document.getElementsByTagName("textarea").length;i++){
        if(document.getElementsByTagName("textarea")[i].value === document.getElementsByTagName("textarea").getAttribute("placeholder")){
          document.getElementsByTagName("textarea")[i].value = '';
        }
      }
  }
    ...
    fix: function (selector) {
      if (this.screenStyleSheet) {
        ...
        for (i=0; i<selectors.length; i++) {
          this.screenStyleSheet.addRule(selectors[i], 'behavior:expression(IE7.PNG.fixPng(this))'); /* seems to execute the function without adding it to the stylesheet - interesting... */
        }
      }
    },
